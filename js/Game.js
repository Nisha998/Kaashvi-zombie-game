class Game {
  ...
  start() {
    ...
    // Adding life sprite in the game
    this.addSprites(heart, 4, lifeImage, 0.04);
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        //use data form the database to display the shooter in x and y direction
  ...
  showLeaderboard() {
    var leader1, leader2;
    var players_set = Object.values(allPlayers);
    if (
      (players_set[0].rank === 0 && players_set[1].rank === 0) ||
      players_set[0].rank === 1
    ) {
  ...
  handleLife(index) {
    // Adding life
    players[index - 1].overlap(heart, function(collector, collected) {
      player.life = 185;
